...
class ObjectDetectionEvaluator(DetectionEvaluator):
  ...
  def add_single_ground_truth_image_info(self, image_id, groundtruth_dict):
    ...
    self._evaluation.add_single_ground_truth_image_info(
        ...
        groundtruth_characteristics=groundtruth_dict[
            standard_fields.InputDataFields.groundtruth_characteristics],
  ...
  def add_single_detected_image_info(self, image_id, detections_dict):
    ...
    self._evaluation.add_single_detected_image_info(
        ...
        detected_characteristics=detections_dict[
            standard_fields.DetectionResultFields.detection_characteristics],
...
class OpenImagesDetectionEvaluator(ObjectDetectionEvaluator):
  ...
  def add_single_ground_truth_image_info(self, image_id, groundtruth_dict):
    ...
    self._evaluation.add_single_ground_truth_image_info(
        ...
        groundtruth_dict[standard_fields.InputDataFields.groundtruth_characteristics],
        groundtruth_classes,
...
class OpenImagesDetectionChallengeEvaluator(OpenImagesDetectionEvaluator):
  ...
  def add_single_detected_image_info(self, image_id, detections_dict):
    ...
    detected_characteristics = detections_dict[
        standard_fields.DetectionResultFields.detection_characteristics][allowed_classes]
    detected_scores = detections_dict[
...
class ObjectDetectionEvaluation(object):
  ...
  def __init__(self,
    ...
    self.groundtruth_characteristics = {}
  ...
  def add_single_ground_truth_image_info(self,
    ...
    self.groundtruth_characteristics[image_key] = groundtruth_characteristics
  ...
  def add_single_detected_image_info(self, image_key, detected_boxes,
    ...
    if image_key in self.groundtruth_boxes:
      ...
      groundtruth_characteristics = self.groundtruth_characteristics[image_key]
      ...
      groundtruth_characteristics = np.empty(shape=[0, 8], dtype=float)
    ...
    scores, tp_fp_labels, is_class_correctly_detected_in_image = (
        self.per_image_eval.compute_object_detection_metrics(
            ...
            groundtruth_characteristics=groundtruth_characteristics,
